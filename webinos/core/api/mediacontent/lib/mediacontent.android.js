...
(function () {
   ...
   * @param item
   */
  function updateItem(params, successCB, errorCB, item) {
   ...
   * @errorCB
   */
  function updateItemsBatch(params, successCB, errorCB, items) {
  }

  function getLocalFolders(params, successCB, errorCB) {
    ...
    mediaFolders = [music, video, pictures];
        ...
        mediaFolder.folderURI = music;
        mediaFolder.title = "MF_Title";
        mediaFolder.storageType = MediaType.MediaFolderType.EXTERNAL;
  ...
  function findItem(params, successCB, errorCB) {
  ...
  function getContents(params, successCB, errorCB, objectRef) {
    var self = this;
    ...
    function success(mediaContents) {
      ...
      readStream.on("end", function (data) {
        ...
        rpc = rpcHandler.createRPC(objectRef, 'onEvent', media);
...
function setRPCHandler(rpcHdlr){
  ...
  // export our object
  exports.fetchMediaInfo = fetchMediaInfo;
  exports.updateItem = updateItem;
  exports.getLocalFolders = getLocalFolders;
